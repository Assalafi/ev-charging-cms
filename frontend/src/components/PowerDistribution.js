...
/**
 * Component that displays power distribution for EV charging stations
 * Shows the breakdown of power sources (Grid, Generator, Solar) used by the charging network
 */
  ...
  const powerSources = [
    {
      ...
      icon: <GridIcon />,
      color: '#2196f3',
      tooltip: 'Power from the national electricity grid',
    ...
    },
    {
      ...
      icon: <SolarIcon />,
      color: '#4caf50',
      tooltip: 'Power from solar installations at charging stations',
      ...
      <CardHeader 
        title={
          <Box display="flex" alignItems="center">
            <Typography variant="h6" component="div">Power Distribution</Typography>
            <Tooltip title="Shows real-time distribution of power sources across EV charging stations">
      ...
      <CardContent>
        ...
        <Box sx={{ mt: 2, p: 1, bgcolor: '#f5f5f5', borderRadius: 1 }}>
          <Typography variant="caption" color="textSecondary">
            EV stations rely on multiple power sources due to grid variability. 
            This helps ensure continuous charging availability across all stations.
          </Typography>
        </Box>
      </CardContent>
    </Card>
