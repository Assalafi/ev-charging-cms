 ...
 * @access  Admin
 */
router.get('/station/:chargePointId', authenticate, requirePermission('stations.monitor'), async (req, res) => {
  try {
 ...
 * @access  Admin
 */
router.post('/station/:chargePointId', authenticate, requirePermission('stations.remote_control'), async (req, res) => {
  try {
    const { chargePointId } = req.params;
 ...
 * @access  Admin
 */
router.post('/all', authenticate, requirePermission('stations.remote_control'), async (req, res) => {
  try {
