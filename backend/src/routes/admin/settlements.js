 ...
 */
router.get('/', authenticate, requirePermission('settlements.view'), async (req, res) => {
  try {
 ...
 * @access  Private (admin)
 */
router.post('/partners/:partnerId/settlements/generate', authenticate, requirePermission('settlements.generate'), async (req, res) => {
  try {
 ...
 * @access  Private (admin)
 */
router.get('/:id', authenticate, requirePermission('settlements.view'), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 * @access  Private (admin)
 */
router.post('/:id/approve', authenticate, requirePermission('settlements.approve'), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 * @access  Private (admin)
 */
router.post('/:id/mark-paid', authenticate, requirePermission('settlements.mark_paid'), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 * @access  Private (admin)
 */
router.post('/:id/cancel', authenticate, requirePermission('settlements.cancel'), async (req, res) => {
  try {
    const { id } = req.params;
